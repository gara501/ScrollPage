...
var App = function App() {
  ...
  var menuLayout = document.querySelector('.menu');
  var pageLayout = document.querySelector('.content-page');
  var scrollActions = document.querySelectorAll('.scroll-action');
  var totalSlides = document.querySelectorAll('.scrollpoint').length;
  var scrollPage = document.querySelector('.scrollpage');
  var slides = document.querySelectorAll('.slide');
  var menuExtItems = document.querySelectorAll('.extmenu');
  var isOpen = false;
  var currentSlide = 1; // Events
  ...
  scrollActions.forEach(function (item) {
  ...
  menuExtItems.forEach(function (item) {
    item.addEventListener('click', function (e) {
      e.preventDefault();
      selectMenuItem(e.currentTarget.dataset.slide);
      selectSlide(e.currentTarget.dataset.slide);
  ...
  function selectMenuItem(menuNumber) {
    removeSelectedMenu();
    scrollActions.forEach(function (item, index) {
